...
import { getEntrenamientos, getEstadisticas, getFechasOrdenadas } from '@/lib/entrenamientos';
...
export default function Home() {
  ...
  const fechas = getFechasOrdenadas();
            ...
            {Object.entries(estadisticas.porTipo).map(([tipo, cantidad]) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-3xl font-bold text-white relative">{cantidad}</p>
